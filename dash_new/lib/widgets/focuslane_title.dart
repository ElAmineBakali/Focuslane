...
class FocusLaneTitle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final c1 = _tune(cs.primary,  lightness: isDark ? 0.10 : 0.00, saturation: 0.10);
    final c2 = _tune(cs.tertiary, lightness: isDark ? 0.00 : -0.05, saturation: 0.05);
    final c3 = _tune(cs.secondary, lightness: isDark ? 0.12 : 0.02, saturation: 0.10);
  ...
  static Color _tune(Color base, {double lightness = 0, double saturation = 0}) {
