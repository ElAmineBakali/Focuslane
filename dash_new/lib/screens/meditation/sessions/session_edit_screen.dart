...
class _SessionEditScreenState extends State<SessionEditScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(editing == null ? 'Nueva sesión' : 'Editar sesión')),
      body: TaskFormTheme(
        child: Padding(
          ...
          child: ListView(
            children: [
              DropdownButtonFormField<SessionType>(
                initialValue: _type,
                items: const [
                  DropdownMenuItem(value: SessionType.timer, child: Text('Temporizador')),
                  DropdownMenuItem(value: SessionType.breath, child: Text('Respiración')),
                  DropdownMenuItem(value: SessionType.guided, child: Text('Guiada')),
                ],
                onChanged: (v) => setState(() => _type = v ?? SessionType.timer),
              ...
              Row(
                children: [
                  ...
                  DropdownButton<int>(
                    value: _durationMin,
                    onChanged: (v) => setState(() => _durationMin = v ?? _durationMin),
