  ...
  Widget build(BuildContext context) {
    return Scaffold(
          ...
          return ListView.separated(
            ...
            itemBuilder: (_, i) {
              ...
              return ListTile(
                ...
                title: Text(p.name),
                subtitle: Text('In ${p.inhale} • Hold ${p.hold} • Ex ${p.exhale} • Hold ${p.hold2} • ${p.cycles} ciclos'),
                trailing: const Icon(Icons.edit),
                onTap: () => Navigator.pushNamed(context, BreathPresetEditScreen.route, arguments: p),
              );
            },
          );
        },
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () => Navigator.pushNamed(context, BreathPresetEditScreen.route),
