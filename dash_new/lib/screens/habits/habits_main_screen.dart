    ...
    return Scaffold(
      ...
      body: StreamBuilder<List<Habit>>(
        ...
        builder: (context, snapshot) {
          ...
          final filteredHabits = _selectedTagFilter == null
              ? _habits
              : _habits.where((h) => h.tags.contains(_selectedTagFilter)).toList();
                      ...
                      ...allTags.map((tag) {
                        return Padding(
                          ...
                          child: FilterChip(
                            ...
                            onSelected: (_) => setState(() => _selectedTagFilter = tag),
                            selectedColor: cs.primaryContainer,
                            showCheckmark: true,
                          ),
                        );
                ...
                child: filteredHabits.isEmpty
                    ? Center(
                        child: Column(
                          ...
                          children: [
                            Icon(Icons.filter_alt_off_rounded, size: 64, color: cs.onSurfaceVariant.withOpacity(0.5)),
                    ...
                    : ReorderableListView(
                      ...
                      onReorder: (oldIndex, newIndex) async {
                        ...
                        for (int i = 0; i < filteredHabits.length; i++) {
                          filteredHabits[i] = filteredHabits[i].copyWith(order: i, isActive: true);
                        }

                        await HabitFirestoreService().updateHabitOrder(filteredHabits);
                        setState(() {});
                      },
                      children: [
                        for (final habit in filteredHabits)
                          Card(
                            ...
                            child: InkWell(
                              onTap: () => Navigator.pushNamed(context, '/habits/detail', arguments: habit),
                                    ...
                                    Container(
                                      ...
                                      child: Center(
                                        child: habit.emoji != null
                                            ? Text(habit.emoji!, style: TextStyle(fontSize: isMobile ? 24 : 28))
                                            : habit.iconCode != null
                                                ? Icon(HabitIcons.getIcon(habit.iconCode), color: habit.color, size: isMobile ? 26 : 30)
                                                : Icon(Icons.check_circle_outline, color: habit.color, size: isMobile ? 26 : 30),
                                      ),
                                    ),
                                        ...
                                        children: [
                                          ...
                                          if (habit.tags.isNotEmpty) ...[
                                            ...
                                            Wrap(
                                              spacing: 6,
                                              runSpacing: 4,
                                              children: habit.tags.take(3).map((tag) {
                                                return Container(
