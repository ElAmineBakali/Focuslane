    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          Text(
            'Fecha: ${session.date} • Duración: ${session.durationMin ?? 0} min',
          ),
          ...
          Card(
            child: ListTile(
              ...
              title: Text(
                'Volumen total: ${session.volumeKg.toStringAsFixed(1)} kg',
              ),
              subtitle: Text(
                'Series: ${session.exercises.fold<int>(0, (a, e) => a + e.sets.length)}',
              ),
            ),
          ),
