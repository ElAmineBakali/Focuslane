...
class _SkillEditScreenState extends State<SkillEditScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(editing == null ? 'Nueva habilidad' : 'Editar habilidad')),
      body: TaskFormTheme(
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: deco('Contexto (herramientas, recursos, bloqueos)'),
                maxLines: 2,
              ),
              const SizedBox(height: 16),
                  ...
                  Expanded(
                    child: Text(
                      _targetDate == null
                          ...
                          : _targetDate!.toLocal().toString().split(' ').first,
                    ),
                  ),
                  TextButton.icon(
                    onPressed: () async {
                  ...
                  child: Row(
                    children: [
                      ...
                      IconButton(
                        ...
                        onPressed: () => setState(() => _metrics.remove(e.key)),
                      ),
                    ],
                  ),
                ),
                ...
                children: [
                  ...
                  ElevatedButton.icon(
                    ...
                    onPressed: () async {
                      ...
                      final unit = await _promptStr('Unidad/ayuda (p.ej. %, bpm, min)');
                      setState(() => _metrics[name.trim()] = unit?.trim() ?? '');
                    },
