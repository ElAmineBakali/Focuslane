...
class _ReviewMonthlyScreenState extends State<ReviewMonthlyScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('Revisión mensual${skill != null ? ' • ${skill!.name}' : ''}')),
      body: skill == null
          ...
          : FutureBuilder<Map<String, double>>(
              ...
              builder: (_, s) {
                ...
                return ListView(
                  ...
                  children: [
                    Text('Reparto por sub-skill (min)', style: Theme.of(context).textTheme.titleLarge),
