...
import 'package:focuslane/screens/study/notifications/study_notifications_screen.dart';
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '$enabledModules módulos con notificaciones activas en configuración persistida.',
                  ),
                ],
              ),
            ),
          ...
          _actionCard(
            context,
            subtitle: 'Los recordatorios se configuran por tarea. Desde aquí puedes limpiar pendientes del módulo.',
            actions: [
              FilledButton.icon(
          ...
          const SizedBox(height: 12),
          _sectionTitle(context, 'Hábitos'),
          _actionCard(
            context,
            subtitle: 'Recordatorios asociados a hábitos. Limpieza central por módulo.',
            actions: [
              FilledButton.icon(
                onPressed: () => _cancelByModule(NotificationModule.habits, 'Hábitos'),
                icon: const Icon(Icons.notifications_off_outlined),
                label: const Text('Cancelar pendientes'),
              ),
            ],
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: OutlinedButton.icon(
                      ...
                      label: const Text('Configuración de estudio'),
                    ),
                  ),
                ),
              ],
          ...
          _actionCard(
            context,
            subtitle: 'Los eventos programados usan el módulo calendar en el core unificado.',
            actions: [
              FilledButton.icon(
                ...
                Align(
                  ...
                  child: Padding(
                    ...
                    child: OutlinedButton.icon(
                      ...
                      icon: const Icon(Icons.tune),
                      label: const Text('Configuración de Food'),
                    ),
                  ),
                ),
              ],
          ...
          _actionCard(
            context,
            subtitle:
                'Peso: ${_gymWeightEnabled ? 'activo' : 'inactivo'} · Medidas: ${_gymMeasurementsEnabled ? 'activo' : 'inactivo'} · Inactividad: ${_gymInactivityEnabled ? 'activo' : 'inactivo'}',
            actions: [
              FilledButton.icon(
                onPressed: _openGymDetails,
                icon: const Icon(Icons.tune),
                label: const Text('Configuración de Gym'),
              ),
              OutlinedButton.icon(
          ...
          Card(
            child: Padding(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Día semanal', style: Theme.of(context).textTheme.labelLarge),
                  const SizedBox(height: 8),
                  DropdownButton<int>(
