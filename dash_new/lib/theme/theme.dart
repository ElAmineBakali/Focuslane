...
class AppTheme {
  ...
  static String presetLabel(ThemePreset p) {
    switch (p) {
      ...
      case ThemePreset.sunset: return 'Sunset';
      case ThemePreset.orchid: return 'Orchid';
      case ThemePreset.tealCarbon: return 'TealCarbon';
      case ThemePreset.graphite: return 'Graphite';
    }
  }
  ...
  static Color _seed(ThemePreset p) {
    switch (p) {
      case ThemePreset.ocean:      return const Color(0xFF2563EB); 
      case ThemePreset.forest:     return const Color(0xFF2E7D32); 
      case ThemePreset.sunset:     return const Color(0xFFF97316);
      case ThemePreset.orchid:     return const Color(0xFF7C3AED);
      case ThemePreset.tealCarbon: return const Color(0xFF0EA5A4);
      case ThemePreset.graphite:   return const Color(0xFF3F3F46);
    }
  }
