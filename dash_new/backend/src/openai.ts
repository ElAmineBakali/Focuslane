...
function maybeExtractTokens(payload: any): number | undefined {
...
export async function callOpenAiJson<T>(options: OpenAiJsonCallOptions<T>): Promise<OpenAiJsonCallResult<T>> {
